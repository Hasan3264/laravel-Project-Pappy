        ...
        <div class="col-md-6 m-auto order-md-1">
           ...
           @endphp
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Delivarey Charge</h6>
                    </div>
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <span class="text-muted">{{ $data['discount'] }}{{ $data['dis_type'] }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <input type="hidden" name="total" value="{{ $data['sub']+$data['charge'] }}">
                    <strong>{{ $data['sub']+$data['charge'] }}Tk</strong>
                </li>
            </ul>
