...
<div class="">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Wellcome, {{$user_name}}</div>
                <!-- //{{Auth::user()->name}} -->
                <div class="row">
                    <div class="col-sm-3">
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Todays Progress</p>
                                        <span class="title text-black font-w600">{{$today_sell}}Tk</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                    <div class="progress-bar bg-success" style="width: 42%; height:5px;"
                                        role="progressbar">
                                        <span class="sr-only">{{$today_sell}}BDT</span>
                                    </div>
                                </div>
                            </div>
                            <div class="effect bg-success" style="top: 57px; left: 582px;"></div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Yesterday Progress</p>
                                        <span class="title text-black font-w600">{{$yesterday_sell}} BDT</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                    <div class="progress-bar bg-secondary" style="width: 82%; height:5px;"
                                        role="progressbar">
                                        <span class="sr-only">{{$yesterday_sell}} BDT</span>
                                    </div>
                                </div>
                            </div>
                            <div class="effect bg-secondary" style="top: 135px; left: 484.5px;"></div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Weekly Sell</p>
                                        <span class="title text-black font-w600">{{$subday_sell}}BDT</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                    <div class="progress-bar bg-danger" style="width: 90%; height:5px;"
                                        role="progressbar">
                                        <span class="sr-only">{{$subday_sell}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="effect bg-danger" style="top: 83px; left: 541px;"></div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Monthly sel</p>
                                        <span class="title text-black font-w600">{{$month_sell}}BDT</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                    <div class="progress-bar bg-warning" style="width: 42%; height:5px;"
                                        role="progressbar">
                                        <span class="sr-only">{{$month_sell}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="effect bg-warning" style="top: -14px; left: 30.5px;"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="col-lg-12">
                            <div class="card avtivity-card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        @foreach (App\Models\product::where('id',$top_sales->id)->get() as $item)
                                        <span class="activity-icon bgl-warning  mr-md-4 mr-3">
                                            <img width="50px"
                                                src="{{asset('uploads/product/preview')}}/{{$item->Product_preview}}"
                                                alt>
                                        </span>
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Top Sell Product</p>
                                        ...
                                        <div class="qnt">
                                            <h3>Qnt:</h3>
                                            <span>
                                                <h6 class="text-center text-blue">{{$top_sales->total}}</h6>
                                            </span>
                                        </div>
                                    </div>
...
<script>
    ...
    const myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Today sells', 'Yesterday sell', 'last Week sell', 'last Mounth'],
            datasets: [{
                label: '# amount',
                data: [{{$today_sell}}, {{$yesterday_sell}}, {{$subday_sell}}, {{$month_sell}}],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
